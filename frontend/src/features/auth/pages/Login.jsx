    ...
    <main className="relative h-screen overflow-hidden bg-[#fbfdfc] px-5 py-5 text-[#17233f]">
      ...
      <section className="relative z-10 mx-auto grid h-full w-full max-w-6xl grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_440px]">
        <aside className="hidden lg:block">
          <div className="inline-flex rounded-full bg-alt px-4 py-2 text-sm font-bold text-primary">
          ...
          <div className="mt-7 grid max-w-lg gap-4 sm:grid-cols-2">
            <Card className="bg-card/80 p-5">
              <p className="text-3xl font-black text-primary">24/7</p>
              <p className="mt-1 text-sm text-body">Account access</p>
            </Card>
            <Card className="bg-card/80 p-5">
              <p className="text-3xl font-black text-primary">OTP</p>
              <p className="mt-1 text-sm text-body">Verified security</p>
            </Card>
          </div>
        </aside>

        <Card className="w-full bg-card/92 p-5 shadow-[0_24px_80px_rgba(23,35,63,0.13)] ring-slate-200/70 backdrop-blur sm:p-7">
          <BrandBadge />
