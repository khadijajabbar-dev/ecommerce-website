...
const fieldClass =
  "h-11 w-full rounded-xl border border-[#e5e7eb] bg-card px-4 text-sm font-medium text-[#17233f] outline-none transition placeholder:text-[#8a97aa] focus:border-primary focus:ring-4 focus:ring-primary/10";
...
const ContactFormSection = () => {
  return (
    <section id="contact-form" className="mx-auto grid w-full max-w-7xl gap-6 px-4 py-7 sm:px-6 lg:grid-cols-[1.08fr_1fr] lg:px-8">
      <form className="rounded-2xl border border-[#e5e7eb] bg-card p-6 shadow-lg shadow-slate-200/60">
        ...
        <label className="mt-5 block">
          ...
          <textarea
            className="mt-2 min-h-32 w-full resize-y rounded-xl border border-[#e5e7eb] bg-card px-4 py-3 text-sm font-medium text-[#17233f] outline-none transition placeholder:text-[#8a97aa] focus:border-primary focus:ring-4 focus:ring-primary/10"
        ...
        <button
          type="button"
          className="mt-5 inline-flex h-12 items-center justify-center gap-3 rounded-xl bg-primary px-7 text-sm font-extrabold text-white shadow-lg shadow-primary/20 transition hover:-translate-y-0.5 hover:bg-primary"
        >
          Submit Message
      ...
      <div className="grid gap-5">
        <article className="rounded-2xl border border-[#e5e7eb] bg-card p-6 shadow-lg shadow-slate-200/60">
          <h2 className="text-2xl font-black tracking-normal text-[#17233f]">
          ...
          <div className="mt-5 grid gap-4">
            {supportReasons.map((reason) => (
              <div key={reason.title} className="flex items-start gap-4">
                <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-alt text-primary">
        ...
        <article className="flex flex-col justify-between gap-4 rounded-2xl border border-[#e5e7eb] bg-card p-6 shadow-lg shadow-slate-200/60 sm:flex-row sm:items-center">
          <span>
          ...
          <button
            type="button"
            className="inline-flex h-11 items-center justify-center gap-3 rounded-xl border border-primary/45 bg-card px-5 text-sm font-extrabold text-primary transition hover:bg-alt"
          >
            View Help Center
